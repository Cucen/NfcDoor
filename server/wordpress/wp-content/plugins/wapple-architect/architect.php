...
Plugin URI: http://blog.wapple.net/wordpress-mobile-plugin-install-guide-and-faq/
Description: Wapple Architect Mobile Plugin for Wordpress is a plugin that allows you to mobilize your blog in minutes. After activating this plugin visit <a href="admin.php?page=architect-basic">the settings page</a> and enter your Wapple Architect Dev Key
Author: Wapple
Version: 4.2
Author URI: http://blog.wapple.net/author/richg
Latest Changes: <span class="new">Google Canonical tag support</span>|Google Analytics Support|Integration with Google Analyticator|Compatibility with SmartPhone Location Lookup|Sidebar functionality|Mobile Stats
Coming Soon: Support for All in One SEO Pack|Support for Google Maps
*/
...
if(!function_exists('add_architect_options_page'))
{
	function add_architect_options_page()
	{
		...
		} else
		{
			...
			add_submenu_page('architect-status', 'Wapple Architect Analytics Settings', 'Analytics', 'administrator', 'architect-analytics', 'architect_options_analytics');
