...
body.body{font-size:14px;font-size:14px !important;background:#c1c1c1 url(<?php echo WP_PLUGIN_URL.'/'.get_wapl_plugin_base();?>/theme/images/iphoneLight/bg.jpg) repeat-x 0 0;color:#383838;}
a{color:#505c75;}
...
.description{color:#454545;font-size:1em;margin-bottom:10px;}
.entry_row{padding-bottom:0;}
.entry_row.singlepost_row{background:#ffffff;}
.nav_row{margin-bottom:10px;clear:both;margin-top:10px;background:url(<?php echo WP_PLUGIN_URL.'/'.get_wapl_plugin_base();?>/theme/images/iphoneLight/menuLeft.png) no-repeat left top;background-size:1024px 100%;}
.nav{line-height:48px;text-align:center;background:url(<?php echo WP_PLUGIN_URL.'/'.get_wapl_plugin_base();?>/theme/images/iphoneLight/menuRight.png) no-repeat right top;background-size:65px 100%;}
...
.entry_row.h2 a{color:#454545;font-size:1.4em;font-weight:bold;text-decoration:none;font-family:"Helvetica Neue",Helvetica,Arial;padding-left:5px;}
