...
.nav{line-height:48px;text-align:center;background:url(<?php echo WP_PLUGIN_URL.'/'.get_wapl_plugin_base();?>/theme/images/iphoneDark/menuRight.png) no-repeat right top;background-size:65px 100%;}
