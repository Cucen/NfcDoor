...
* Plus much much more! For a full feature list, visit the [plugin homepage](http://blog.wapple.net/wordpress-mobile-plugin-install-guide-and-faq/)
...
1. To install through WordPress Control Panel:
	...
	* Enter your Wapple Architect dev key into the control panel. You can get one from here [Wapple Dev Key Registration](http://wapple.net/signup/wordpress)
...
1. http://blog.wapple.net screenshot-1.jpg
...
Head over to [Wapple](http://wapple.net/signup/wordpress) and fill out the simple form, you should be able to get your dev key within a couple of minutes!
...
= 4.2 =
* Updated wording in the plugin to reflect changes in the Wapple package

= 4.1 =
* Added canonical links to make Google SEO more friendly
* Fixed issue with menu not showing permalinks correctly
* Fixed an issue with menus growing
* Added option to remove menu separators

= 4.0 =
* Added Google Analytics Support
* Integration with Google Analyticator

= 3.9.7 =
* Fixed menu ordering - now more consistent with desktop order

= 3.9.6 =
* Removed donate links 

= 3.9.5 =
* Added new URLs for signup

= 3.9.4 =
* Fixed Twitter link
* Updated styles and error handling when no dev key found
