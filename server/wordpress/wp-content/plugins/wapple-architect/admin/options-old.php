...
{
	echo '<div class="updated architectInitError"><p><strong>You haven\'t saved your Wapple Architect Dev Key, get one from here: <a href="http://wapple.net/signup/wordpress">http://wapple.net/signup/wordpress</a></strong></p></div>';
}
...
echo '<p><em>Wapple Architect WordPress plugin is brought to you by Rich Gubby - <a href="http://blog.wapple.net">http://blog.wapple.net</a></em></p>';
