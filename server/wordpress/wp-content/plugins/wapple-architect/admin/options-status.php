...
{
	$errors = true;
	echo '<div class="updated architectInitError"><p><strong>You haven\'t saved your Wapple Architect Dev Key, get one from here: <a href="http://wapple.net/signup/wordpress" target="_blank">http://wapple.net/signup/wordpress</a></strong>. Once you have it, enter it in the <a href="admin.php?page=architect-basic">Wapple Architect Basic Settings page</a></p></div>';
}
...
if($curlresult != 'Invalid Dev Key')
{
	$statsresult = simplexml_load_string($curlresult);
}
curl_close($c);
