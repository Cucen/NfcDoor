	...
	function architect_admin_option($type, $options = array())
	{
		...
		switch($type)
		{
			case 'input' : 
				...
				{
					$string .= ' readonly="'.$options['readonly'].'"';
				}
...
function architect_options_analytics()
{
...
function architect_install()
{
	if(!get_option('architect_install'))
	{
		...
		('.$blog_id.', \'architect_showfootertext\', \'Powered by [url=http://http://blog.wapple.net/wordpress-mobile-plugin-install-guide-and-faq/]Wapple Architect Mobile Plugin[/url]\', \'yes\')';
