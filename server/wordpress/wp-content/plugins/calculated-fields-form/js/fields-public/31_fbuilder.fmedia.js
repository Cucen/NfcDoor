	...
	$.extend( 
		...
		$.fbuilder.controls[ 'ffields' ].prototype,
		{
            ...
            show:function()
				{
						return '<div class="fields '+this.csslayout+'" id="field'+this.form_identifier+'-'+this.index+'"><div class="clearer">'+this[ '_show_'+this.sMediaType]()+'</div><span class="uh">'+this.data[ this.sMediaType].sFigcaption+'</span><div class="clearer"></div></div>';
				}
		}
	);